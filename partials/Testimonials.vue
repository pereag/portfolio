    ...
    <SectionWrapper>
      <SectionHeadingHighlighted>
        ...
        <SectionTitle>
          ...
          <template #faded>used by the leaders</template>
        </SectionTitle>

        <SectionDescription
          >Don't just take our word for it. Read what others say about
          Recharger.</SectionDescription
        >
      </SectionHeadingHighlighted>

      <div
        class="[mask-image:linear-gradient(to_right, transparent,black_15%,black_85%,transparent)] mt-8 lg:mt-32">
        <div
          class="flex w-max animate-marquee items-stretch [--duration:50s] hover:[animation-play-state:paused]">
          <div
            v-for="testimonial in [...testimonials, ...testimonials]"
            :key="testimonial.name"
            class="px-2.5">
            <SpotlightCard class="relative h-full w-[28rem] p-8">
