  ...
  <PrimaryFeatureCard>
    <template #preview>
      ...
      <div class="w-[6.5rem] overflow-hidden">
        <div class="flex w-max animate-marquee justify-end [animation-direction:reverse] [animation-duration:6s]">
    ...
    <template #default>
      Effortlessly upload the PDFs you want to chat with. Get things started with just a few clicks and your documents
